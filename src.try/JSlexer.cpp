...
void JSlexit(wxStyledTextCtrl* pane){  // lex the script window
 ...
 //     wxFont font(10, wxFONTFAMILY_MODERN, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL);
        ...
        pane->StyleSetForeground(wxSTC_C_WORD, *wxBLUE);// for supported keywords
        pane->StyleSetForeground(wxSTC_C_WORD2, wxColour(255,125,0));  // orange for unsupported keywords
        pane->StyleSetForeground(wxSTC_C_GLOBALCLASS, wxColour(0, 160,160));  // dark cyan for extensions
