...
{ // 3
	...
	expected: {"PGN":129285,"id":"navigationRouteWpInformation","description":"Navigation - Route/WP Information","priority":3,"destination":255,"origin":1,"startRps":"undefined","nitemsCount":2,"databaseId":"undefined","routeId": "undefined","navigationDirectionInRoute":{"value":0,"name":"Forward"},"supplementaryRouteWpDataAvailable":{"value":0,"name":"Off"},"routeName":"SEN004","nitems":[{"wpId":0,"wpName":""},{"wpId":1,"wpName":"Poole Bar","wpLatitude":50.6548312,"wpLongitude":-1.9189831}]},
	tracing: 0
	},
{ // 4
	pgn: 126996,
...
// we patch the descriptor and the expected result so they have binary data
descriptor.Fields[2].FieldType = "BINARY";
expected = tests[testToUse].expected;
expected.productCode = "1111110111101000";	// patch expected
