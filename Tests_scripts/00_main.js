...
tests = [ // test table format
	...
	{name:"Context menu", functionToUse:loadRunWait, script:"76_contextMenu_test.js", time:60, result:{type:4, value:"OK"}},
	...
	{name:"N2k decode/encode", functionToUse:loadRunWait, script:"110_n2k_encode_decode.js", time:5, result:{type:4, value:"All tests passed"}},
